...
<form action="<?php echo bloginfo('url'); ?>/<?php echo AgentStormSettingCache::get('as_idx_searchprefix'); ?>" method="GET" />
    ...
    <?php if (AgentStormSettingCache::get('as_searchwidget_desc')): ?>
    <p>
        <?php echo AgentStormSettingCache::get('as_searchwidget_desc'); ?>
    </p>
    <?php endif; ?>
    ...
    <div class="agentstorm-search">
        ...
        <div class="agentstorm-formitem">
            ...
            <select id="agentstorm-dd-type" name="as_propertytype">
                ...
                <?php if (AgentStormSettingCache::get('as_idx_settings_classes_con', false) == true): ?><option value="CON" <?php if ($_GET['as_propertytype'] == 'CON'): ?>selected="selected"<?php endif; ?>>Condominiums</option><?php endif; ?>
            </select>
        </div>
        <?php endif; ?>
        ...
        <div class="agentstorm-formitem">
            ...
            <input type="text" id="agentstorm-dd-subdivision" name="as_subdivision" value="<?php echo $_GET['as_subdivision']; ?>" />
        </div>
        <?php endif; ?>
        ...
        <div class="agentstorm-formitem" style="overflow:hidden;">
            ...
            <input type="checkbox" name="as_shortsale" value="1" />
        </div>
        <?php endif; ?>
        ...
        <div class="agentstorm-formitem">
            ...
            <input type="checkbox" name="as_foreclosure" value="1" />
        </div>
        <?php endif; ?>
        
        <div class="agentstorm-search-submit">
            <button <?php if(AgentStormSettingCache::get('as_contact_loginhook', false) && AgentStormSettingCache::get('as_force_login', false)): ?>class="required_login"<?php endif; ?>><?php echo (AgentStormSettingCache::get('aas_searchwidget_button')) ? AgentStormSettingCache::get('as_searchwidget_button') : 'Search'; ?></button>
        </div>
