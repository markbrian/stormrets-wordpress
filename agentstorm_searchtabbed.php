...
<script type="text/javascript"> 
    function tabview_aux(TabViewId, id) { 
        ...
        while (Tabs.className != "agentstorm-tabcontainer" ) Tabs = Tabs.nextSibling; 
        ...
        while (Tab = Tab.nextSibling); 
            ...
            while (Pages.className != 'agentstorm-tabpages') Pages = Pages.nextSibling; 
            var Page = Pages.firstChild; 
            var i    = 0; 
        do { 
            if (Page.className == 'agentstorm-tabpage') { 
              i++; 
    ...
    <div class="agentstorm-tabs" id="agentstorm-tabs"> 
        <div class="agentstorm-tabcontainer"> <?php if (AgentStormSettingCache::get('as_idx_settings_classes_res', false) == true): ?><a>Residential</a><?php endif; ?> <?php if (AgentStormSettingCache::get('as_idx_settings_classes_mob', false) == true): ?><a>Mobile</a><?php endif; ?> <?php if (AgentStormSettingCache::get('as_idx_settings_classes_lnd', false) == true): ?><a>Land</a><?php endif; ?> <?php if (AgentStormSettingCache::get('as_idx_settings_classes_com', false) == true): ?><a>Commercial</a><?php endif; ?> </div> 
        <div class="agentstorm-tabpages">
            <?php if (AgentStormSettingCache::get('as_idx_settings_classes_res', false) == true): ?>
            <div class="agentstorm-tabpage"> 
                <div class="agentstorm-tabpadding">
                    <div class="agentstorm-search">
                        ...
                        <form action="<?php echo get_bloginfo('url', 'display') . '/' . AgentStormSettingCache::get('as_idx_searchprefix'); ?>" method="get"> 
                            ...
                            <input type="hidden" name="as_propertytype" value = "RES" />
            ...
            <?php endif; ?>
            <?php if (AgentStormSettingCache::get('as_idx_settings_classes_mob', false) == true): ?>
            <div class="agentstorm-tabpage"> 
                <div class="agentstorm-tabpadding"> 
                    <div class="agentstorm-search">
                        ...
                        <form action="<?php echo get_bloginfo('url', 'display') . '/' . AgentStormSettingCache::get('as_idx_searchprefix'); ?>" method="get"> 
                            ...
                            <input type="hidden" name="as_searchwidget_submit" value="1" />
                            <input type="hidden" name="as_propertytype" value = "MOB" />
            ...
            <?php endif; ?>
            <?php if (AgentStormSettingCache::get('as_idx_settings_classes_lnd', false) == true): ?>
            <div class="agentstorm-tabpage"> 
                <div class="agentstorm-tabpadding"> 
                    ...
                    <div class="agentstorm-search">
                        ...
                        <form action="<?php echo get_bloginfo('url', 'display') . '/' . AgentStormSettingCache::get('as_idx_searchprefix'); ?>" method="get">
                            ...
                            <input type="hidden" name="as_searchwidget_submit" value="1" />
                            <input type="hidden" name="as_propertytype" value = "LND" />
            ...
            <?php endif; ?>
            <?php if (AgentStormSettingCache::get('as_idx_settings_classes_com', false) == true): ?>
            <div class="agentstorm-tabpage"> 
                <div class="agentstorm-tabpadding">
...
<script type="text/javascript"> 
    tabview_initialize('agentstorm-tabs'); 
</script> 
