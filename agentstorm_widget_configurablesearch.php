...
<?php if (AgentStormSettingCache::get('as_configurablesearchwidget_desc')): ?>
<p>
    <?php echo AgentStormSettingCache::get('as_configurablesearchwidget_desc'); ?>
</p>
<?php endif; ?>
...
<div class="agentstorm-search">
    ...
    <form action="<?php echo bloginfo('url'); ?>/<?php echo AgentStormSettingCache::get('as_idx_searchprefix'); ?>" method="GET">
        ...
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_type', true)): ?>
        ...
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_suburbzip', true)): ?>
            <div class="agentstorm-formitem">
        ...
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_subdivision', true)): ?>
            <div class="agentstorm-formitem">
                <label>Sub Division</label><br />
                <input type="text" id="agentstorm-dd-subdivision" name="as_subsivision" value="<?php echo $_GET['as_subdivision']; ?>" />
            </div>
        <?php endif; ?>
            
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_price', true)): ?>
            <div class="agentstorm-formitem">
        ...
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_bedrooms', true)): ?>
            <div class="agentstorm-formitem">
        ...
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_bathrooms', true)): ?>
            <div class="agentstorm-formitem">
        ...
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_size', true)): ?>
        ...
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_lotsize', true)): ?>
        <div class="agentstorm-formitem" style="margin-top:1.5em;">
        ...
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_shortsale', true)): ?>
        <div class="agentstorm-formitem" style="overflow:hidden;">
            <label>Short Sale</label><br />
            <input type="checkbox" name="as_shortsale" value="1" <?php if ($_GET['as_shortsale'] == '1'): ?>checked="checked"<?php endif; ?> />
        </div>
        <?php endif; ?>
        
        <?php if (AgentStormSettingCache::get('as_configurablesearchwidget_foreclosure', true)): ?>
        <div class="agentstorm-formitem">
            <label>Foreclosure</label><br />
            <input type="checkbox" name="as_foreclosure" value="1" <?php if ($_GET['as_foreclosure'] == '1'): ?>checked="checked"<?php endif; ?> />
        </div>
        <?php endif; ?>
